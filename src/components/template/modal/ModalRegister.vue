<template>
  <div class="normal-case tracking-normal">
    <a href="/signup" @click.prevent="show" class="text-white p-2 hover:text-black-600">Register</a>
    <modal name="modal-register" @opened="opened" :adaptive="true" :height="560" :width="500">
